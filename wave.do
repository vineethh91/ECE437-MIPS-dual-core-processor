...
add wave -noupdate -expand -group core1 -radix hexadecimal /tb_cpu/DUT/theCPU/MyAwesomeCore1/WBSignal_WB
add wave -noupdate -expand -group core1 -radix hexadecimal /tb_cpu/DUT/theCPU/MyAwesomeCore1/WBSignal_M
...
WaveRestoreCursors {{Core1 Halts} {1093118 ns} 1} {{Core1 Starts dumping} {1072008 ns} 1} {{Core0 starts waiting on Core1} {995795 ns} 1} {{Cursor 6} {693256 ns} 0}
...
update
WaveRestoreZoom {688007 ns} {708347 ns}
